...
import type { Engine, StudioSettings } from "@colibri/contracts"
...
export function SettingsDialog({ open, settings, engines, saving, onClose, onSave }: SettingsDialogProps) {
